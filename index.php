       ...
       if(isset($_POST['submit']))
        ...
        $length = strlen($mobileno);
            ...
            elseif ( $name_length < 5 ) {
                $name_err = "<br>Name must be more than 5 letters.";
            }
            // else  $name_err ="";
            ...
            elseif ($agree == '') {
                ...
                $form_success_msg = "You have successfully submitted the Form.";
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="hacker.png">
...
<body>
    ...
    <input type="text" name="name" placeholder="Hari Bahadur" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name'], ENT_QUOTES) : ''; ?>">
    ...
    <input type="text" name="email" placeholder="abcd@example.com" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email'], ENT_QUOTES) : ''; ?>" >
    ...
    <input type="text" name="mobileno" placeholder="9812345678" value="<?php echo isset($_POST['mobileno']) ? htmlspecialchars($_POST['mobileno'], ENT_QUOTES) : ''; ?>" >
    <span><?php echo $mobile_err ?></span>  
     
    <br><br>  

    <label>Website: </label> 
    <input type="text" name="website" placeholder="www.example.com" value="<?php echo isset($_POST['website']) ? htmlspecialchars($_POST['website'], ENT_QUOTES) : ''; ?>" > 
